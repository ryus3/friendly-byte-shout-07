                                ...
                                <div className="flex items-center gap-1">
                                  {(notificationType === 'ai_order' || notificationType === 'new_ai_order') && (
                                    <span
                                      title="Telegram"
                                      aria-label="Telegram"
                                      className="inline-flex items-center justify-center h-5 w-5 rounded-full text-white bg-gradient-to-br from-sky-400 to-indigo-500 shadow-sm flex-shrink-0"
                                    >
