                  ...
                  <div className="space-y-2.5">
                    ...
                    {order.exchange_metadata.outgoing_items?.length > 0 && (
                      <div className="relative group/out">
                        ...
                        <div className="relative p-2 bg-gradient-to-br from-orange-50/90 to-amber-50/90 dark:from-orange-950/30 dark:to-amber-950/30 rounded-xl border border-orange-200/50 dark:border-orange-800/50 backdrop-blur-sm transition-all duration-300">
                          {/* أيقونة وعنوان */}
                          <div className="flex items-center gap-2 mb-2">
                            <div className="flex-shrink-0 relative">
                              <div className="absolute inset-0 bg-orange-500/20 rounded-lg blur-md"></div>
                              <div className="relative flex items-center justify-center w-9 h-9 bg-gradient-to-br from-orange-500 to-amber-600 rounded-lg shadow-lg">
                          ...
                          <div className="space-y-1">
                            {order.exchange_metadata.outgoing_items.map((item, idx) => (
                              <div key={idx} className="flex items-center gap-1.5 p-1 bg-white/50 dark:bg-gray-900/30 rounded-lg">
                                {item.color_hex && (
                                  <div className="relative">
                                    <div 
                                      className="w-4 h-4 rounded-full shadow-inner ring-2 ring-white dark:ring-gray-800 hover:scale-110 transition-transform duration-200" 
                                      style={{ 
                                ...
                                {item.size && (
                                  <span className="px-1 py-0 text-[9px] font-medium bg-orange-200/50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-full">
                                    {item.size}
                                  </span>
                                )}
                    ...
                    {order.exchange_metadata.incoming_items?.length > 0 && (
                      <div className="relative group/in">
                        ...
                        <div className="relative p-2 bg-gradient-to-br from-blue-50/90 to-cyan-50/90 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-xl border border-blue-200/50 dark:border-blue-800/50 backdrop-blur-sm transition-all duration-300">
                          {/* أيقونة وعنوان */}
                          <div className="flex items-center gap-2 mb-2">
                            <div className="flex-shrink-0 relative">
                              <div className="absolute inset-0 bg-blue-500/20 rounded-lg blur-md"></div>
                              <div className="relative flex items-center justify-center w-9 h-9 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg shadow-lg">
                          ...
                          <div className="space-y-1">
                            {order.exchange_metadata.incoming_items.map((item, idx) => (
                              <div key={idx} className="flex items-center gap-1.5 p-1 bg-white/50 dark:bg-gray-900/30 rounded-lg">
                                ...
                                {item.size && (
                                  <span className="px-1 py-0 text-[9px] font-medium bg-blue-200/50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full">
                                    {item.size}
                                  </span>
                                )}
