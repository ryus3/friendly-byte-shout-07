            ...
            <div className="flex items-start justify-between">
              ...
              {isLocalOrder && order.status !== 'completed' && order.status !== 'cancelled' && order.status !== 'returned_in_stock' ? (
                <Button
                  ...
                  className={`${statusConfig.color} transform group-hover:scale-105 transition-all duration-300 hover:shadow-lg min-h-[40px] max-h-[40px] px-3 py-2 rounded-lg`}
                ...
                <div className={`flex items-center gap-2 ${statusConfig.color} transform group-hover:scale-105 transition-transform duration-300 min-h-[40px] max-h-[40px] px-3 py-2 rounded-lg`}>
