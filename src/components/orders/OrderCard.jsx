          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start justify-between">
              ...
              {isLocalOrder && order.status !== 'completed' && order.status !== 'cancelled' && order.status !== 'returned_in_stock' ? (
                ...
                <div className={`flex items-center gap-2 ${statusConfig.color} font-bold rounded-lg text-xs max-w-[180px] px-2 py-1 hover:shadow-md group-hover:scale-105 transition-all duration-300`}>
