            ...
            <div className="flex items-start justify-between">
              ...
              {isLocalOrder && order.status !== 'completed' && order.status !== 'cancelled' && order.status !== 'returned_in_stock' ? (
                <Button
                  ...
                  className={`${statusConfig.color} font-bold rounded-lg h-auto transition-all duration-300 ${(statusConfig.label.includes('قيد التوصيل') || statusConfig.label.includes('قيد التجهيز')) ? 'px-3 py-2 max-w-[180px] hover:shadow-lg group-hover:scale-110 transform' : 'px-2 py-1 max-w-[180px] hover:shadow-md group-hover:scale-105'}`}
                ...
                <div className={`flex items-center gap-2 ${statusConfig.color} font-bold rounded-lg text-xs transition-all duration-300 ${(statusConfig.label.includes('قيد التوصيل') || statusConfig.label.includes('قيد التجهيز')) ? 'px-3 py-2 max-w-[180px] hover:shadow-lg group-hover:scale-110 transform' : 'px-2 py-1 max-w-[180px] hover:shadow-md group-hover:scale-105'}`}>
