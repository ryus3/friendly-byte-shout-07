...
const QuickOrderMobileOptimized = ({ isDialog = false, onOrderCreated, formRef, setIsSubmitting, isSubmittingState, aiOrderData = null }) => {
  return (
...
export default QuickOrderMobileOptimized;