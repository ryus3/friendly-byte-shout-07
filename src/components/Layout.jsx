...
import { 
  ...
  Settings, PackagePlus, Users, Briefcase, Sun, Moon, Bot, ArrowRight, Zap, DollarSign, Shield, RefreshCw, Bell, Wallet, Heart, Store, Inbox
} from 'lucide-react';
...
const SidebarContent = ({ onClose, isMobile }) => {
  ...
  const menuItems = [
    ...
    { path: '/employee-products', icon: PackagePlus, label: 'إدارة المنتجات', roles: ['super_admin', 'admin', 'department_manager', 'sales_employee'], requiresFinancialCenter: true, color: 'text-cyan-400' },
