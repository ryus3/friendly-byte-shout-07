...
const AccountingPage = () => {
    ...
    const profitCards = [
        { key: 'myProfit', title: "أرباح المبيعات", value: financialSummary.myProfit, icon: User, colors: ['rose-500', 'red-500'], format: 'currency', onClick: () => navigate('/advanced-profits-analysis') },
