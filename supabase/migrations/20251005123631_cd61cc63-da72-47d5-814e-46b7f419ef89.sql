-- إصلاح دالة process_telegram_order لاستخدام full_name بدلاً من username
...
-- تحديث السجلات الموجودة لاستخدام الاسم الكامل
UPDATE public.ai_orders
SET created_by = 'المدير العام'
WHERE created_by IN ('ryus', 'ryusbrand@gmail.com')
  AND source = 'telegram';