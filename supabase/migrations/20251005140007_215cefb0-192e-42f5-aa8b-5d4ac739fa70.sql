-- إصلاح دالة process_telegram_order لحفظ full_name في created_by بدلاً من email أو UUID
...
BEGIN
  ...
  -- البحث عن الموظف باستخدام full_name
  IF p_employee_identifier IS NOT NULL THEN
    SELECT u.id, u.full_name INTO v_employee_id, v_employee_name
  ...
  INSERT INTO ai_orders (
    ...
    'telegram',
    'pending',
    v_employee_name,  -- ✅ حفظ الاسم الكامل بدلاً من UUID أو email
    p_city_id,
    p_region_id,
