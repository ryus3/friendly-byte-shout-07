-- إصلاح دالة حساب الأرباح - تصحيح استدعاء الدالة الفرعية
...
-- تشغيل حساب الأرباح للطلب ORD000002 الذي استلم الفاتورة
SELECT public.calculate_order_profit_fixed_amounts('00798655-f91d-45d4-b1b5-e1dfc1a47266'::uuid);