-- إصلاح دالة fix_inventory_discrepancies - إزالة performed_by لأنه UUID وليس string
...
BEGIN
  ...
  LOOP
    ...
    -- إزالة performed_by من INSERT لأن العمود UUID ويقبل NULL
    INSERT INTO inventory_operations_log (
      ...
      notes, source_type, performed_at
    ) VALUES (
