-- إصلاح function approve_employee_complete لجعل الموظف حقيقي 100%
...
BEGIN
  ...
  -- 4. إضافة دور موظف المبيعات (تم إصلاح اسم العمود)
  INSERT INTO public.user_roles (
    user_id,
    role_id,
    is_active,
    assigned_at,  -- تم تغيير created_at إلى assigned_at
    assigned_by
  ) VALUES (
    p_user_id,
    v_sales_role_id,
