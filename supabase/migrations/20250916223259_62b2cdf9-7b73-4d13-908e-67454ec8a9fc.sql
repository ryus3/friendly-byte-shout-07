-- حذف جميع دوال process_telegram_order تدريجياً بالمعاملات الصحيحة
...
DROP FUNCTION IF EXISTS public.process_telegram_order(jsonb, text, text, text, text, text, numeric, jsonb, bigint, text, integer, integer);
