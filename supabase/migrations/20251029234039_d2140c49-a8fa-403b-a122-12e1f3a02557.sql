-- تعديل دالة process_telegram_order لاستقبال رقمين هاتف
...
BEGIN
  ...
  -- استخراج رقم الهاتف (رقمين) والعنوان
  ...
  RAISE NOTICE '📱 رقم الهاتف الأساسي: %', v_customer_phone;
  RAISE NOTICE '📱 رقم الهاتف الثانوي: %', v_secondary_phone;
