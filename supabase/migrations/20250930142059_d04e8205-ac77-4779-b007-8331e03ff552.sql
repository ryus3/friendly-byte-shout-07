-- تعديل جدول ai_orders لجعل customer_name اختياري مع قيمة افتراضية
ALTER TABLE ai_orders 
ALTER COLUMN customer_name SET DEFAULT 'زبون تليغرام',
ALTER COLUMN customer_name DROP NOT NULL;

-- تحديث دالة process_telegram_order لاستخراج اسم الزبون بذكاء
