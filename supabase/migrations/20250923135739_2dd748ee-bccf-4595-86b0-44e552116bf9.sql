-- Fix the process_telegram_order stored procedure
-- The issue is it tries to insert into 'customer_region' which doesn't exist
-- Should be 'customer_province' instead
