-- إصلاح دالة sync_alwaseet_invoice_data لحل مشكلة column reference ambiguous
...
BEGIN
  ...
  LOOP
    ...
    -- Insert or update the delivery invoice order (fixed ambiguous reference)
    INSERT INTO public.delivery_invoice_orders (
      ...
      invoice_id,  -- This is clearly the invoice_id from the RETURNING clause above
      local_order_id,
      order_data->>'id',
      order_data,
      v_current_user_id
