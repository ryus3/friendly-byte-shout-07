-- إزالة جميع دوال process_telegram_order المتضاربة
DROP FUNCTION IF EXISTS public.process_telegram_order CASCADE;

-- إنشاء دالة إنشاء الطلبات الصحيحة التي تستخدم نظام employee_code
