-- تحديث دالة process_telegram_order لتشمل أجور التوصيل في المبلغ الإجمالي
...
DECLARE
  ...
  v_delivery_fee numeric := 5000; -- القيمة الافتراضية
BEGIN
  -- البحث عن الموظف
  ...
  -- إذا لم تُقرأ، استخدم القيمة الافتراضية
