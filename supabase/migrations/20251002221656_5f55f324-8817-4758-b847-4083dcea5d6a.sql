-- إصلاح نهائي: حذف image_url من smart_inventory_search
-- المشكلة: العمود p.image_url غير موجود في جدول products
-- الحل: حذف image_url تماماً لأن التليغرام لا يحتاج صور
