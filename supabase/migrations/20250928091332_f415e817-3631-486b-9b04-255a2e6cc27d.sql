-- إعادة إنشاء دالة استخراج المنتجات بشكل كامل ومحسن
...
BEGIN
  ...
  IF v_selected_product IS NOT NULL THEN
      ...
      ELSE
        ...
        v_final_items := v_final_items || jsonb_build_array(
          jsonb_build_object(
            ...
            'quantity', 1,
            'unit_price', (v_selected_product->>'price')::numeric,
            'total_price', (v_selected_product->>'price')::numeric,
    ...
    ELSE
      ...
      v_final_price := (v_selected_product->>'price')::numeric;
