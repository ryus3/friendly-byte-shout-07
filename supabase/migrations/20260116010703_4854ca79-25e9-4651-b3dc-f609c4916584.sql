-- Fix upsert_alwaseet_invoice_list to preserve actual received_at dates
...
BEGIN
  ...
  LOOP
    ...
    -- ✅ CRITICAL FIX: استخدام التاريخ الحقيقي من الفاتورة وليس now()
    v_received_at := CASE 
    ...
    ON CONFLICT (external_id, partner) DO UPDATE SET
      ...
      -- ✅ CRITICAL: حفظ التاريخ الأصلي وعدم الكتابة فوقه
