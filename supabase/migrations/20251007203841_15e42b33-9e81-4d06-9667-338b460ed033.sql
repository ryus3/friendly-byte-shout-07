-- إصلاح الدالة الصحيحة - حذف وإعادة إنشاء
...
-- 2️⃣ إنشاء الدالة الصحيحة ذات 7 معاملات
...
BEGIN
  ...
  -- البحث عن معرف المستخدم من employee_code (التصحيح الأساسي)
  ...
  -- استخراج الملاحظات باستخدام regex محسّن
