...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // ✅ استثناء الحالات النهائية فقط (مطابق لسلوك أبريل):
    //   delivery_status 4 = تم التسليم (لا يتغيّر، ينتظر الفاتورة فقط)
    //   delivery_status 17 = راجع للتاجر (نهائي)
    //   status completed/returned_in_stock = نهائي محلياً
