  ...
  try {
    ...
    if (!employee) {
      ...
      if (text.startsWith('/start')) {
        await sendTelegramMessage(chatId, `
🤖 <b>مرحباً بك في بوت RYUS للطلبات الذكية!</b>

📱 <b>لربط حسابك بالبوت:</b>
1️⃣ اضغط على زر <b>Start</b> أولاً (تم ✅)
2️⃣ احصل على رمزك الخاص من موقع RYUS
3️⃣ أرسل الرمز هنا للربط

🔗 <b>كيفية الحصول على الرمز:</b>
• ادخل إلى موقع RYUS الخاص بك
• اذهب إلى الإعدادات ⚙️
• انقر على "بوت التليغرام"
• انسخ رمزك الخاص

📝 <b>مثال على الرمز:</b> <code>RYU1234</code>
...
🔗 تم ربط حسابك مع بوت RYUS بنجاح
...
07801234567
بغداد - الكرادة
تيشيرت أزرق M + بنطلون أسود L
50 ألف

💡 أرسل "مساعدة" في أي وقت لمعرفة كيفية إرسال الطلبات
        `);
      } else {
        await sendTelegramMessage(chatId, `
...
🔍 <b>يرجى التحقق من:</b>
• أن الرمز صحيح ومطابق تماماً
• عدم وجود مسافات زائدة
• أن الرمز من موقع RYUS الصحيح

📱 <b>للحصول على الرمز الصحيح:</b>
1️⃣ ادخل إلى موقع RYUS
2️⃣ اذهب إلى الإعدادات ⚙️  
3️⃣ انقر على "بوت التليغرام"
4️⃣ انسخ رمزك والصقه هنا

<i>مثال صحيح: RYU1234</i>
        `);
      }
      return new Response('OK', { status: 200 });
    }
...
🏷 <b>تنسيق الطلب المطلوب (بالترتيب):</b>
1️⃣ اسم الزبون (اختياري - إذا لم تكتبه سيكون افتراضي)
2️⃣ العنوان (مطلوب للتوصيل أو "محلي" للاستلام)
3️⃣ رقم الهاتف (10-11 رقم)
4️⃣ المنتجات (اسم + لون + مقاس)
5️⃣ السعر الإجمالي (اختياري - سيحسب تلقائياً)

<b>📦 مثال طلب توصيل:</b>
ريوس
بغداد الدورة شارع الصحة
07728020024
...
<b>🌍 مدن مدعومة:</b>
بغداد، بصرة، أربيل، الموصل، كربلاء، النجف، بابل، ذي قار، ديالى، الأنبار، وجميع محافظات العراق

<b>💡 نصائح مهمة:</b>
• العنوان مطلوب ويأتي بعد اسم الزبون مباشرة
• للتوصيل: اذكر المدينة + المنطقة + تفاصيل العنوان
• للاستلام المحلي: اكتب فقط "محلي"
• للمنتجات المتعددة استخدم + بينها
• البوت يفهم صيغ مختلفة لأسماء المدن (بصرة، البصرة، بصره)

<b>🚀 أوامر أخرى:</b>
• "إحصائيات" لمعرفة طلباتك اليومية
• "حالة" لمعرفة آخر طلباتك
      `);
      return new Response('OK', { status: 200 });
    }
...
ابدأ بإرسال أول طلب لك! 🚀
    ...
    // معالجة الطلب
    console.log('Processing order from employee:', employee.employee_code, 'Text:', text);
    const orderId = await processOrderText(text, chatId, employee.employee_code);
    
    if (orderId) {
      console.log('Order processed successfully with ID:', orderId);
      await sendTelegramMessage(chatId, `
🎉 <b>تم استلام طلبك بنجاح!</b>

🆔 <b>رقم الطلب:</b> <code>#${orderId.toString().slice(-8)}</code>
👤 <b>الموظف:</b> ${employee.full_name}
...
📱 ستصلك إشعارات عند:
• الموافقة على الطلب ✅
• وجود ملاحظات أو تعديلات ⚠️
• تغيير حالة الطلب 📦

<i>شكراً لك ${employee.full_name}! استمر في العمل الرائع 🚀</i>
      `);
    } else {
      console.log('Order processing failed for employee:', employee.employee_code);
      await sendTelegramMessage(chatId, `
❌ <b>خطأ في معالجة الطلب</b>

🔍 <b>يرجى التحقق من التنسيق والمحاولة مرة أخرى:</b>

<b>📋 التنسيق المطلوب:</b>
1️⃣ اسم الزبون (اختياري)
2️⃣ رقم الهاتف (10-11 رقم)  
3️⃣ نوع التسليم:
   • للتوصيل: اذكر المدينة والمنطقة
   • للاستلام: اكتب "محلي"
4️⃣ المنتجات (اسم + لون + مقاس)
5️⃣ السعر (اختياري - سيحسب تلقائياً)

<b>✅ مثال توصيل:</b>
أحمد محمد
07728020024
بغداد - الكرادة
قميص أزرق M + بنطلون أسود L
45 ألف

<b>✅ مثال استلام محلي:</b>
سارة أحمد
07712345678
محلي
فستان أحمر L
...
💡 <b>نصيحة:</b> أرسل "مساعدة" للحصول على دليل مفصل
      `);
    }
